...
from .modules.ltcp import LocalEnhancedTemporalContextPropagation, LTCPConfig, get_ltcp_memory_dtype


class STCMTrackInference_DINOv2(nn.Module):
    """Evaluation-time STCMTrack: TMoE adapters are applied when the checkpoint is loaded; LTCP keeps a per-sequence search-token memory."""
    def __init__(self, vit: DinoVisionTransformer,
                 ...
                 ltcp_config: Optional[dict] = None):
        super().__init__()
